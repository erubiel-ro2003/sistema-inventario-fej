...
export interface ApiDevolucionDevolucion extends Struct.CollectionTypeSchema {
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Relation<
      ...
      'api::categoria.categoria'
    >;
    compras: Schema.Attribute.Relation<'manyToMany', 'api::compra.compra'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.String;
    devolucion: Schema.Attribute.Relation<
      'oneToOne',
      'api::devolucion.devolucion'
    >;
...
export interface ApiTenantTenant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    devolucions: Schema.Attribute.Relation<
      'oneToMany',
      'api::devolucion.devolucion'
    >;
    direccion: Schema.Attribute.String;
    empresa_id: Schema.Attribute.UID<'nombre'>;
    estado: Schema.Attribute.Enumeration<['activo', 'suspendido']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tenant.tenant'
